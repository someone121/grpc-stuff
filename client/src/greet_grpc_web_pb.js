 ...
 */
const methodDescriptor_Greeter_Unary = new grpc.web.MethodDescriptor(
  '/greet.Greeter/Unary',
 ...
 */
proto.greet.GreeterClient.prototype.unary =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/greet.Greeter/Unary',
      request,
      metadata || {},
      methodDescriptor_Greeter_Unary,
      callback);
};
 ...
 */
proto.greet.GreeterPromiseClient.prototype.unary =
 ...
 *   !proto.greet.HelloReply>}
 */
const methodDescriptor_Greeter_ServerStreaming = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.greet.GreeterClient.prototype.serverStreaming =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/greet.Greeter/ServerStreaming',
      request,
      metadata || {},
      methodDescriptor_Greeter_ServerStreaming);
};
 ...
 *     The XHR Node Readable Stream
 */
proto.greet.GreeterPromiseClient.prototype.serverStreaming =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/greet.Greeter/ServerStreaming',
      request,
