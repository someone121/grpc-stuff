...
goog.exportSymbol('proto.greet.DelayedReply', null, global);
 ...
 * @constructor
 */
proto.greet.DelayedReply = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.greet.DelayedReply.repeatedFields_, null);
};
goog.inherits(proto.greet.DelayedReply, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.greet.DelayedReply.displayName = 'proto.greet.DelayedReply';
}
 ...
 * @return {string}
 */
proto.greet.HelloRequest.prototype.getGreeting = function() {
 ...
 * @return {!proto.greet.HelloRequest} returns this
 */
proto.greet.HelloRequest.prototype.setGreeting = function(value) {
 ...
 * @const
 */
proto.greet.DelayedReply.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.greet.DelayedReply.prototype.toObject = function(opt_includeInstance) {
  return proto.greet.DelayedReply.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.greet.DelayedReply} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.greet.DelayedReply.toObject = function(includeInstance, msg) {
  var f, obj = {
    message: jspb.Message.getFieldWithDefault(msg, 1, ""),
    requestList: jspb.Message.toObjectList(msg.getRequestList(),
    proto.greet.HelloRequest.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.greet.DelayedReply}
 */
proto.greet.DelayedReply.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.greet.DelayedReply;
  return proto.greet.DelayedReply.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.greet.DelayedReply} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.greet.DelayedReply}
 */
proto.greet.DelayedReply.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.greet.HelloRequest;
      reader.readMessage(value,proto.greet.HelloRequest.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.greet.DelayedReply.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.greet.DelayedReply.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.greet.DelayedReply} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.greet.DelayedReply.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getMessage();
  if (f.length > 0) {
    writer.writeString(
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.greet.HelloRequest.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {string}
 */
proto.greet.DelayedReply.prototype.getMessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.greet.DelayedReply} returns this
 */
proto.greet.DelayedReply.prototype.setMessage = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Array<!proto.greet.HelloRequest>}
 */
proto.greet.DelayedReply.prototype.getRequestList = function() {
  return /** @type{!Array<!proto.greet.HelloRequest>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.greet.HelloRequest, 2));
};


/**
 * @param {!Array<!proto.greet.HelloRequest>} value
 * @return {!proto.greet.DelayedReply} returns this
*/
proto.greet.DelayedReply.prototype.setRequestList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.greet.HelloRequest=} opt_value
 * @param {number=} opt_index
 * @return {!proto.greet.HelloRequest}
 */
proto.greet.DelayedReply.prototype.addRequest = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.greet.HelloRequest, opt_index);
};
 ...
 * @return {!proto.greet.DelayedReply} returns this
 */
proto.greet.DelayedReply.prototype.clearRequestList = function() {
